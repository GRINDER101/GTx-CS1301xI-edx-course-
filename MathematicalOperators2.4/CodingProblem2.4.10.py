...
desired_hour = length // 60
desired_minute = (length % 60)
added_hour = (desired_minute + start_minute) // 60
final_minute = str((desired_minute + start_minute) % 60)
final_hour = str(desired_hour + start_hour + added_hour)
