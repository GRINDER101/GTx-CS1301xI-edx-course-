...
quarters = int(amount / quarters_value)
dimes = int((amount % quarters_value) / dime_value)
nickels = int(((amount % quarters_value) % dime_value) / nickel_value)
pennies = int((((amount % quarters_value) % dime_value) %
              nickel_value) / penny_value)
