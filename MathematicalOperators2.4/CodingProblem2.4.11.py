...
# Add your code here!
took_something_cross_reactive1 = not took_something_cross_reactive
not_night = not is_nighttime

how_much_to_take_in_morning = (
    not_night * (time_since_last_dose > 1) * time_since_last_dose * dosage)

how_much_to_take_at_night = is_nighttime * \
    ((time_since_last_dose > 1) * (time_since_last_dose * dosage * 2))

consume_no_cross_reactive = took_something_cross_reactive1 * \
    (not_night * (time_since_last_dose > 1) * time_since_last_dose * dosage)

consume_no_cross_reactive_at_night = (took_something_cross_reactive1 * is_nighttime * (
    (time_since_last_dose > 1) * (time_since_last_dose * dosage * 2)))

how_much_to_take = ((how_much_to_take_in_morning or how_much_to_take_at_night) and (
    consume_no_cross_reactive or consume_no_cross_reactive_at_night))

print(how_much_to_take)
