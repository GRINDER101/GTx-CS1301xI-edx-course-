...
pay_for_the_trip = can_afford and destination_is_safe

cannot_afford_it = destination_is_safe and (
    educational_value or relatives_nearby)

are_you_sure_about_this_location = (is_international and have_passport and not afraid_to_fly) or (
    not is_international or (have_a_car or not afraid_to_fly))

do_you_actually_want_to_go = (is_a_beach and is_warm) or (
    has_skiing and not is_warm) or (is_a_city and (is_off_peak or has_attraction))

both_beach_and_city = ((is_a_beach and is_warm) or (is_a_city and (is_off_peak or has_attraction))) or (
    (has_skiing and not is_warm) or (is_a_city and (is_off_peak or has_attraction)))

print((pay_for_the_trip or cannot_afford_it) and (
    are_you_sure_about_this_location and do_you_actually_want_to_go and both_beach_and_city))
