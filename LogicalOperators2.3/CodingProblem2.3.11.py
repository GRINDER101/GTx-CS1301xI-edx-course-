...
Not_have_an_exam_1 = (sunny and (
    (sunblock and morning_classes) or night_classes))

Not_have_an_exam_2 = (raining and rain_jacket)

Not_have_an_exam_3 = (snowing and ((friends_are_going and fluffy_coat) or (
    snow_boots and fluffy_coat) or really_want_to_go))

Do_not_want_to_go_to_class = (Have_an_exam or Not_have_an_exam_1 or Not_have_an_exam_2
                              or Not_have_an_exam_3)

print("True or false: I should go to class:", Do_not_want_to_go_to_class)
