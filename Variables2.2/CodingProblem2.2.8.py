...
number_of_earlier_date = int(earlier_date.day)
number_of_later_date = int(later_date.day)
days_between = number_of_later_date - number_of_earlier_date
...
print("There are", days_between, "days between",
